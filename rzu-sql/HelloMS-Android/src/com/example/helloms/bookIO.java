...
public class bookIO extends SQLiteOpenHelper{

	String TAG="message";
	private static final int version=1;
	private SQLiteDatabase db;
	//构造函数重载
	public bookIO(Context context, String name) {
		this(context, name,version);
		// TODO Auto-generated constructor stub
	}
	//构造函数重载
	public bookIO(Context context, String name,int version) {
		super(context, name,null, version);
		// TODO Auto-generated constructor stub
	}
	//SQLiteOpenHelper中必须包含的构造函数
	public bookIO(Context context, String name, CursorFactory factory,
			int version) {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		Log.e(TAG,"数据库创建");
		this.db =db;
		db.execSQL("create table user(_id int,name vchar(10),isbn vchar(250));");
		Log.e(TAG,"数据库创建成功");
	}
